...
//첨부파일 보여주기	
	function showUploadResult(uploadResultArr){
		...
		$(uploadResultArr).each(function(i, obj){
			//image type
			if(obj.image){
				var fileCallPath = encodeURIComponent( obj.uploadPath + "/s_" + obj.uuid.trim() + "_" + obj.fileName );
				
				str += "<li data-path='" + obj.uploadPath + "'";
				str += " data-uuid='" + obj.uuid.trim() + "' data-filename='" + obj.fileName + "' data-type='" + obj.image + "'>";
				str += "<div>";
				str += "<span style='color:black'> " + obj.fileName + "</span>";
